...
void test1()
{
    ...
    showInfo(&pool, static_cast<char*>("申请50个512字节的内存块"));
    ...
    showInfo(&pool, static_cast<char*>("销毁50个512字节的内存块"));
    ...
    showInfo(&pool, static_cast<char*>("申请30个5120字节的内存块"));
    ...
    showInfo(&pool, static_cast<char*>("销毁30个5120字节的内存块"));
